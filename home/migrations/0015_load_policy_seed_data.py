...
- 자립준비청년_지원제도_통합일정표.xlsx -> 모집 일정만 있는 정책 17건
  ("자립수당 지급 사업"은 정책DB의 중앙부처 자립수당과 동일 제도라 그쪽으로 일정만 병합)
...
DETAILED_POLICIES = [
    {
        ...
        # 정책DB 엑셀의 신청 기간은 "상시"지만, 통합일정표의 "자립수당 지급 사업"이
        # 같은 제도라 중복 등록 대신 이쪽으로 모집 일정을 병합했다.
        "application_start": date(2026, 8, 25),
        "application_end": date(2026, 9, 15),
    },
    {
